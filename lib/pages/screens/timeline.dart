        ...
        switch (tabController.index) {
          ...
          case 1:
           ...
           // titleString= DatetimeHelper(timestamp: (docSnap['day1'] as Timestamp).millisecondsSinceEpoch).getMonthName();
            titleString = '${( docSnap["day1"] as Timestamp).toDate().day}-${DatetimeHelper(timestamp: (docSnap['day1'] as Timestamp).millisecondsSinceEpoch).getMonthName()}';
            break;
          case 2:
            titleString = '${( docSnap["day2"] as Timestamp).toDate().day}-${DatetimeHelper(timestamp: (docSnap['day2'] as Timestamp).millisecondsSinceEpoch).getMonthName()}';
            break;
          case 3:
            titleString = '${( docSnap["day3"] as Timestamp).toDate().day}-${DatetimeHelper(timestamp: (docSnap['day3'] as Timestamp).millisecondsSinceEpoch).getMonthName()}';
            break;
        }
      });
